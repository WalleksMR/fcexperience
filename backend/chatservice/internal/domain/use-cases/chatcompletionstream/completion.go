...
import (
	...
	"github.com/walleksmr/fcexperience/backend/chatservice/internal/domain/gateway"
)
...
func (us *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	resp, err := us.OpenAiClient.CreateChatCompletionStream(ctx, openai.ChatCompletionRequest{
	...
	if err != nil {
		return nil, errors.New("error creating chat complation: " + err.Error())
	}
	...
	if err != nil {
		return nil, errors.New("error creating associate message: " + err.Error())
	}
